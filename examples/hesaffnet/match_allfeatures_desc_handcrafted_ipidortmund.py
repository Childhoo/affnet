...
#directory = r"E:/evaluation_img_learnedaff/images/"
directory = r"E:/eval_img_learnedaff_ipidortmund/images/" #for new experiments
import glob
...
#    np.savetxt(out_file_ori_name, LAFs, fmt='%10.9f')
    ...
    #    np.savetxt(out_file_ori_name, LAFs, fmt='%10.9f')
#    np.savetxt(out_file_ori_name, descriptors.cpu().numpy(), fmt='%d')
